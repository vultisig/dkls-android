...
public class goschnorr implements goschnorrConstants {
  ...
  public static lib_error schnorr_keygen_setupmsg_new(SWIGTYPE_p_uint32_t threshold, go_slice key_id, go_slice ids, tss_buffer setup_msg) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_keygen_setupmsg_new(SWIGTYPE_p_uint32_t.getCPtr(threshold), go_slice.getCPtr(key_id), key_id, go_slice.getCPtr(ids), ids, tss_buffer.getCPtr(setup_msg), setup_msg));
  }
  ...
  public static lib_error schnorr_keygen_session_input_message(Handle session, go_slice message, SWIGTYPE_p_int32_t finished) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_keygen_session_input_message(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, SWIGTYPE_p_int32_t.getCPtr(finished)));
  }
  ...
  public static lib_error schnorr_keygen_session_message_receiver(Handle session, go_slice message, SWIGTYPE_p_uint32_t index, tss_buffer receiver) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_keygen_session_message_receiver(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, SWIGTYPE_p_uint32_t.getCPtr(index), tss_buffer.getCPtr(receiver), receiver));
  }
  ...
  public static lib_error schnorr_decode_party_name(go_slice setup, SWIGTYPE_p_uint32_t index, tss_buffer message) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_decode_party_name(go_slice.getCPtr(setup), setup, SWIGTYPE_p_uint32_t.getCPtr(index), tss_buffer.getCPtr(message), message));
  }
  ...
  public static lib_error schnorr_sign_session_input_message(Handle session, go_slice message, SWIGTYPE_p_uint32_t finished) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_sign_session_input_message(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, SWIGTYPE_p_uint32_t.getCPtr(finished)));
  }
  ...
  public static lib_error schnorr_sign_session_message_receiver(Handle session, go_slice message, SWIGTYPE_p_uint32_t index, tss_buffer receiver) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_sign_session_message_receiver(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, SWIGTYPE_p_uint32_t.getCPtr(index), tss_buffer.getCPtr(receiver), receiver));
  }
  ...
  public static lib_error schnorr_key_export_receiver_input_message(Handle session, go_slice message, SWIGTYPE_p_int32_t finished) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_key_export_receiver_input_message(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, SWIGTYPE_p_int32_t.getCPtr(finished)));
  }
  ...
  public static lib_error schnorr_key_import_initiator_new(go_slice private_key, SWIGTYPE_p_uint8_t threshold, go_slice ids, tss_buffer setup_msg, Handle session) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_key_import_initiator_new(go_slice.getCPtr(private_key), private_key, SWIGTYPE_p_uint8_t.getCPtr(threshold), go_slice.getCPtr(ids), ids, tss_buffer.getCPtr(setup_msg), setup_msg, Handle.getCPtr(session), session));
  }
