...
#include <string.h>
#include <stdint.h>
#include "go-schnorr.h"  // Include your tss_buffer struct definition

JNIEXPORT void JNICALL
Java_com_silencelaboratories_goschnorr_BufferUtilJNI_set_1bytes_1on_1tss_1buffer(JNIEnv *env,
                                                                                       jobject obj,
                                                                                       jobject jarg1,
                                                                                       jbyteArray jarg1_) {
...
Java_com_silencelaboratories_goschnorr_BufferUtilJNI_get_1bytes_1from_1tss_1buffer(
...
JNIEXPORT void JNICALL
Java_com_silencelaboratories_goschnorr_BufferUtilJNI_set_1bytes_1on_1go_1slice(JNIEnv *env,
                                                                               jobject obj,
                                                                               jobject jarg1,
                                                                               jbyteArray jarg1_) {
    jsize byteArrayLen = (*env)->GetArrayLength(env, jarg1_);
...
JNIEXPORT jbyteArray JNICALL
Java_com_silencelaboratories_goschnorr_BufferUtilJNI_get_1bytes_1from_1go_1slice(
        JNIEnv *env, jobject obj, jobject jarg1) {
    jclass goSliceClass = (*env)->GetObjectClass(env, jarg1);
    jfieldID ptrField = (*env)->GetFieldID(env, goSliceClass, "swigCPtr", "J");
    jlong swigCPtr = (*env)->GetLongField(env, jarg1, ptrField);
...
JNIEXPORT void JNICALL
Java_com_silencelaboratories_goschnorr_BufferUtilJNI_free_1go_1slice_1payload(JNIEnv *env,
                                                                               jobject obj,
                                                                               jobject jarg1) {
    jclass goSliceClass = (*env)->GetObjectClass(env, jarg1);
    jfieldID ptrField = (*env)->GetFieldID(env, goSliceClass, "swigCPtr", "J");
