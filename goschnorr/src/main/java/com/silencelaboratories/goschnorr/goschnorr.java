...
public class goschnorr implements goschnorrConstants {
  ...
  public static lib_error schnorr_keygen_session_input_message(Handle session, go_slice message, SWIGTYPE_p_int finished) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_keygen_session_input_message(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, SWIGTYPE_p_int.getCPtr(finished)));
  }
  ...
  public static lib_error schnorr_key_export_receiver_input_message(Handle session, go_slice message, SWIGTYPE_p_int finished) {
    return lib_error.swigToEnum(goschnorrJNI.schnorr_key_export_receiver_input_message(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, SWIGTYPE_p_int.getCPtr(finished)));
  }
