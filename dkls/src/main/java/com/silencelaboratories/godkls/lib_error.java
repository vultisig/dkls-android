...
public final class lib_error {
  ...
  public final static lib_error LIB_INVALID_PUBLIC_KEY = new lib_error("LIB_INVALID_PUBLIC_KEY");
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_1 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_1", godklsJNI.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_1_get());
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_2 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_2");
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_3 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_3");
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_4 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_4");
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_5 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_5");
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_6 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_6");
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_7 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_7");
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_8 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_8");
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_9 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_9");
  public final static lib_error LIB_ABORT_PROTOCOL_AND_BAN_PARTY_10 = new lib_error("LIB_ABORT_PROTOCOL_AND_BAN_PARTY_10");
  public final static lib_error LIB_ABORT_PROTOCOL_PARTY_1 = new lib_error("LIB_ABORT_PROTOCOL_PARTY_1", godklsJNI.LIB_ABORT_PROTOCOL_PARTY_1_get());
  ...
  private static lib_error[] swigValues = { LIB_OK, LIB_INVALID_HANDLE, LIB_HANDLE_IN_USE, LIB_INVALID_HANDLE_TYPE, LIB_NULL_PTR, LIB_INVALID_BUFFER_SIZE, LIB_INVALID_SESSION_STATE, LIB_UNKNOWN_ERROR, LIB_SERIALIZATION_ERROR, LIB_INVALID_DERIVATION_PATH_STR, LIB_DERIVATION_ERROR, LIB_SETUP_MESSAGE_VALIDATION, LIB_NON_EMPTY_OUTPUT_BUFFER, LIB_SIGNGEN_ERROR, LIB_KEYGEN_ERROR, LIB_QC_ERROR, LIB_KEY_EXPORT_ERROR, LIB_INVALID_PARTY_LIST, LIB_INVALID_OLD_PARTY_LIST, LIB_INVALID_NEW_PARTY_LIST, LIB_INVALID_PUBLIC_KEY, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_1, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_2, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_3, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_4, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_5, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_6, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_7, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_8, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_9, LIB_ABORT_PROTOCOL_AND_BAN_PARTY_10, LIB_ABORT_PROTOCOL_PARTY_1, LIB_ABORT_PROTOCOL_PARTY_2, LIB_ABORT_PROTOCOL_PARTY_3, LIB_ABORT_PROTOCOL_PARTY_4, LIB_ABORT_PROTOCOL_PARTY_5, LIB_ABORT_PROTOCOL_PARTY_6, LIB_ABORT_PROTOCOL_PARTY_7, LIB_ABORT_PROTOCOL_PARTY_8, LIB_ABORT_PROTOCOL_PARTY_9, LIB_ABORT_PROTOCOL_PARTY_10 };
