...
public class godkls {
  ...
  public static lib_error dkls_keygen_setupmsg_new(long threshold, go_slice key_id, go_slice ids, tss_buffer setup_msg) {
  ...
  public static lib_error dkls_keygen_session_message_receiver(Handle session, go_slice message, long index, tss_buffer receiver) {
    return lib_error.swigToEnum(godklsJNI.dkls_keygen_session_message_receiver(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, index, tss_buffer.getCPtr(receiver), receiver));
  }
  ...
  public static lib_error dkls_hd_setupmsg_new(go_slice key_id, go_slice chain_path, go_slice ids, tss_buffer setup_msg) {
    return lib_error.swigToEnum(godklsJNI.dkls_hd_setupmsg_new(go_slice.getCPtr(key_id), key_id, go_slice.getCPtr(chain_path), chain_path, go_slice.getCPtr(ids), ids, tss_buffer.getCPtr(setup_msg), setup_msg));
  }

  public static lib_error dkls_hd_session_from_setup(go_slice setup, go_slice id, Handle share, Handle hnd) {
    return lib_error.swigToEnum(godklsJNI.dkls_hd_session_from_setup(go_slice.getCPtr(setup), setup, go_slice.getCPtr(id), id, Handle.getCPtr(share), share, Handle.getCPtr(hnd), hnd));
  }

  public static lib_error dkls_hd_session_input_message(Handle session, go_slice message, int[] finished) {
    return lib_error.swigToEnum(godklsJNI.dkls_hd_session_input_message(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, finished));
  }

  public static lib_error dkls_hd_session_output_message(Handle session, tss_buffer message) {
    return lib_error.swigToEnum(godklsJNI.dkls_hd_session_output_message(Handle.getCPtr(session), session, tss_buffer.getCPtr(message), message));
  }

  public static lib_error dkls_hd_session_message_receiver(Handle session, go_slice message, long index, tss_buffer receiver) {
    return lib_error.swigToEnum(godklsJNI.dkls_hd_session_message_receiver(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, index, tss_buffer.getCPtr(receiver), receiver));
  }

  public static lib_error dkls_hd_session_free(Handle session) {
    return lib_error.swigToEnum(godklsJNI.dkls_hd_session_free(Handle.getCPtr(session), session));
  }

  public static lib_error dkls_hd_session_finish(Handle session, Handle output) {
    return lib_error.swigToEnum(godklsJNI.dkls_hd_session_finish(Handle.getCPtr(session), session, Handle.getCPtr(output), output));
  }
  ...
  public static lib_error dkls_qc_session_message_receiver(Handle session, go_slice message, long index, tss_buffer receiver) {
    return lib_error.swigToEnum(godklsJNI.dkls_qc_session_message_receiver(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, index, tss_buffer.getCPtr(receiver), receiver));
  }
  ...
  public static lib_error dkls_decode_party_name(go_slice setup, long index, tss_buffer message) {
    return lib_error.swigToEnum(godklsJNI.dkls_decode_party_name(go_slice.getCPtr(setup), setup, index, tss_buffer.getCPtr(message), message));
  }
  ...
  public static lib_error dkls_sign_session_input_message(Handle session, go_slice message, int[] finished) {
    return lib_error.swigToEnum(godklsJNI.dkls_sign_session_input_message(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, finished));
  }
  ...
  public static lib_error dkls_sign_session_message_receiver(Handle session, go_slice message, long index, tss_buffer receiver) {
    return lib_error.swigToEnum(godklsJNI.dkls_sign_session_message_receiver(Handle.getCPtr(session), session, go_slice.getCPtr(message), message, index, tss_buffer.getCPtr(receiver), receiver));
  }
